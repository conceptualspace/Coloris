...
((window, document, Math, undefined) => {
  ...
  function init() {
    ...
    '</div>'+
    `<button type="button" id="clr-eye-dropper" class="clr-eye-dropper" aria-label="${settings.a11y.eyeDropper}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m2 22 1-1h3l9-9"></path><path d="M3 21v-3l9-9"></path><path d="m15 6 3.4-3.4a2.1 2.1 0 1 1 3 3L18 9l.4.4a2.1 2.1 0 1 1-3 3l-3.8-3.8a2.1 2.1 0 1 1 3-3l.4.4Z"></path></svg></button>`+
    ...
    addListener(getEl('clr-eye-dropper'), 'click', event => {
      if (window.EyeDropper) {
